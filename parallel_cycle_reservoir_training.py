...
for epoch in range(epochs):
    ...
    for data, label in tqdm(train_loader):
        ...
        epoch_accuracy =epoch_accuracy + acc / len(train_loader)
    ...
    with torch.no_grad():
        ...
        for data, label in test_loader:
            ...
            epoch_test_accuracy = epoch_test_accuracy + acc / len(test_loader)
            epoch_test_loss = epoch_test_loss + test_loss / len(test_loader)
